...
public class DominanceComparator<S extends Solution<?>> implements Comparator<S>, Serializable {
  private OverallConstraintViolationComparator<S> constraintViolationComparator;
  ...
  /** Constructor */
  public DominanceComparator(OverallConstraintViolationComparator<S> constraintComparator) {
    this(constraintComparator, 0.0) ;
  }

  /** Constructor OverallConstraintViolationComparator */
  public DominanceComparator(OverallConstraintViolationComparator<S> constraintComparator, double epsilon) {
  ...
  public int compare(S solution1, S solution2) {
    if (solution1 == null) {
      throw new MooreException("Solution1 is null") ;
    } else if (solution2 == null) {
      throw new MooreException("Solution2 is null") ;
    } else if (solution1.getNumberOfObjectives() != solution2.getNumberOfObjectives()) {
      throw new MooreException("Cannot compare because solution1 has " +
