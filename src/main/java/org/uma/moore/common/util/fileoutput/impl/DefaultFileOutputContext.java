package org.uma.moore.common.util.fileoutput.impl;


import org.uma.moore.common.util.MooreException;
import org.uma.moore.common.util.fileoutput.FileOutputContext;
...
public class  DefaultFileOutputContext implements FileOutputContext {
  ...
  public BufferedWriter getFileWriter() {
    ...
    try {
      ...
      throw new MooreException("Exception when calling method getFileWriter()", e) ;
    }
