...
public class DynamicDoubleProblem implements DoubleProblem {
  ...
  public DoubleSolution createSolution() {
    return new DoubleSolution(getNumberOfVariables(), getNumberOfObjectives(), lowerBounds, upperBounds)  ;
  }
  ...
  public void evaluate(DoubleSolution solution) {
    ...
    if (getNumberOfConstraints() > 0) {
      ...
      solution.setAttribute("OVERVALL_CONSTRAINT_VIOLATION", overallConstraintViolation);
